...
export default function ManagerSharedGoalsPage() {
  ...
  const groups = state.sharedGoalGroups
    .slice()
    .sort((a, b) => b.createdAt.localeCompare(a.createdAt))
    .filter((g) => g.createdById === user.id);

  return (
    <div className="flex flex-col gap-4">
      <div className="rounded-xl border border-zinc-200 bg-white p-5">
        <div className="text-lg font-semibold text-zinc-900">Shared Goals</div>
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-5">
        <div className="text-sm font-semibold text-zinc-900">My shared goal pushes</div>
